...
export default {
    ...
    computed: {
        ...
        formattedDatetime() {
            ...
            return this.selectedDatetime ? DateTime.fromJSDate(this.selectedDatetime).toFormat(this.dateTimeFormat) : ''
        },
        selectedDatetime() {
            if (this.date && this.time) {
                ...
                return DateTime.fromFormat(datetimeString, this.defaultDateTimeFormat).toJSDate();
            } else {
                return null
            }
        },
    ...
    methods: {
        init() {
            ...
            if (initDateTime) {
                ...
                this.date = initDateTime.toFormat(DEFAULT_DATE_FORMAT);
                this.time = initDateTime.toFormat(DEFAULT_TIME_FORMAT);
            }
        },
        okHandler() {
            this.resetPicker()
